...
public class Cardiologist extends Doctor {
    private int heartSurgeriesPerformed;
    private int cardiacPatientNum;

    public Cardiologist() {
        super();
        this.heartSurgeriesPerformed = 0;
        this.cardiacPatientNum = 0;
    }

    public Cardiologist(String id, String name, String workTime, String qualification, int room, int heartSurgeriesPerformed, int cardiacPatientNum) {
        super(id, name, "Cardiologist", workTime, qualification, room);
        this.heartSurgeriesPerformed = heartSurgeriesPerformed;
        this.cardiacPatientNum = cardiacPatientNum;
    }
    ...
    public BorderPane newDoctor() {
		...
		TextField inputSpecialist = new TextField("Cardiologist");
     ...
     // Populate time options
		...
		Label lbHeartSurgeriesPerformed = createLabel("Heart Surguries Performed");
		Label colon6 = createLabel(":");
		TextField inputHeartSurgeriesPerformed = new TextField();
		
		Label lbCardiacPatientNum = createLabel("Cardiac Patient Number");
		Label colon7 = createLabel(":");
		TextField inputCardiacPatientNum = new TextField();
		...
		Text newDoctorMsg = new Text("Cardiologist");
        ...
        gridPane.add(lbHeartSurgeriesPerformed, 0, 6);
        gridPane.add(colon7, 1, 6);
        gridPane.add(inputHeartSurgeriesPerformed, 2, 6);
        
        gridPane.add(lbCardiacPatientNum, 0, 7);
        gridPane.add(colon8, 1, 7);
        gridPane.add(inputCardiacPatientNum, 2, 7);
		...
		btRegister.setOnAction(e -> {
		    try {
		        ...
		        if (inputId.getText().trim().isEmpty() ||
		            ...
		            inputHeartSurgeriesPerformed.getText().trim().isEmpty() ||
		            inputCardiacPatientNum.getText().trim().isEmpty()) {
		        ...
		        if(Integer.parseInt(inputHeartSurgeriesPerformed.getText()) < 0) {
		        	throw new IllegalArgumentException("Heart Surguries Performed field value MUST be a positive integer.");
		        }
		        if(Integer.parseInt(inputCardiacPatientNum.getText()) < 0) {
		        	throw new IllegalArgumentException("Cardiac Patient Number field value MUST be a positive integer.");
		        }
		        ...
		        this.setHeartSurgeriesPerformed(Integer.parseInt(inputHeartSurgeriesPerformed.getText()));
		        this.setPatientsWithHeartCondition(Integer.parseInt(inputCardiacPatientNum.getText()));
		        ...
		        showAlert("Input Error", "Please enter valid numbers in Room, Heart Surgeries, and Patients fields.");
		...
		btClear.setOnAction(e -> {
            ...
            inputRoom.clear();
            inputHeartSurgeriesPerformed.clear();
            inputCardiacPatientNum.clear();
        });
		
		return borderPane;
	}
    
    public int getHeartSurgeriesPerformed() {
        return heartSurgeriesPerformed;
    }

    public void setHeartSurgeriesPerformed(int heartSurgeriesPerformed) {
        this.heartSurgeriesPerformed = heartSurgeriesPerformed;
    }

    public int getPatientsWithHeartCondition() {
        return cardiacPatientNum;
    }

    public void setPatientsWithHeartCondition(int cardiacPatientNum) {
        this.cardiacPatientNum = cardiacPatientNum;
    }
