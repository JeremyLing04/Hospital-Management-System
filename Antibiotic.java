...
public class Antibiotic extends Medicine {
    ...
    private String targetedBacteria;

    public Antibiotic() {
        super();
        this.dosage = "";
        this.targetedBacteria = "";
    }

    public Antibiotic(String name, String manufacturer, String expiryDate, int cost, int count, String dosage, String targetedBacteria) {
        super(name, manufacturer, expiryDate, cost, count);
        this.dosage = dosage;
        this.targetedBacteria = targetedBacteria;
    }
    ...
    public String getTargetedBacteria() {
        return targetedBacteria;
    }

    public void setTargetedBacteria(String targetedBacteria) {
        this.targetedBacteria = targetedBacteria;
    }
    ...
    public BorderPane newMedicine() {
        ...
        Label lbDosage = createLabel("Dosage");
        Label colon6 = createLabel(":");
        TextField inputDosage = new TextField();
        inputDosage.setPromptText("i.e. 500mg");

        Label lbTargetedBacteria = createLabel("Targeted Bacteria");
        Label colon7 = createLabel(":");
        TextField inputTargetedBacteria = new TextField();

        Button btRegister = createBtn("Register");
        Button btClear = createBtn("Clear");

        Text newMedicineMsg = new Text("New Antibiotic");
        ...
        gridPane.add(inputDosage, 2, 5);

        gridPane.add(lbTargetedBacteria, 0, 6);
        gridPane.add(colon7, 1, 6);
        gridPane.add(inputTargetedBacteria, 2, 6);
        ...
        btRegister.setOnAction(e -> {
            try {
                ...
                if (inputName.getText().trim().isEmpty() ||
                    ...
                    inputDosage.getText().trim().isEmpty() ||
                    inputTargetedBacteria.getText().trim().isEmpty()) {
                ...
                // Create a new Antibiotic instance
                Antibiotic antibiotic = new Antibiotic(
                    ...
                    inputDosage.getText(),
                    inputTargetedBacteria.getText()
                );

                // Add the antibiotic to the list
